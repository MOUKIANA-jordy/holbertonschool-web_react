...
describe('Login component', () => {
  ...
  test('submit becomes enabled with valid credentials', () => {
    render(<Login />);
  ...
  test('uses email and password received through props', () => {
    render(
      <Login
    ...
    expect(
      screen.getByLabelText(/email/i)
    ).toHaveValue('initial@example.com');

    expect(
      screen.getByLabelText(/password/i)
    ).toHaveValue('initialPassword');
  });
});
